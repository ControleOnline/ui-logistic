---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-logistic, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-logistic`.
...
- Checkout local: `app-community/modules/controleonline/ui-logistic`
