...
const createStyles = palette =>
  StyleSheet.create({
    ...
    deliveryRunCurrentStopHeader: {
      flexDirection: 'row',
      alignItems: 'flex-start',
      justifyContent: 'space-between',
      gap: 10,
    },
    deliveryRunCurrentStopTextWrap: {
      flex: 1,
      gap: 4,
    },
    deliveryRunCurrentStopTitle: {
      color: palette?.accentInfo,
      fontSize: 10,
      fontWeight: '900',
      textTransform: 'uppercase',
    ...
    deliveryRunCurrentStopBody: {
      color: palette?.textPrimary,
      fontSize: 14,
      fontWeight: '900',
      lineHeight: 18,
    },
    deliveryRunCurrentStopBadge: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: 5,
      borderRadius: 999,
    ...
    deliveryRunCurrentStopBadgeText: {
      color: '#166534',
      fontSize: 11,
      fontWeight: '900',
    },
    ...
    deliveryRunEmptyTitle: {
      color: palette?.textPrimary,
      fontSize: 13,
      fontWeight: '900',
    },
    deliveryRunEmptyText: {
      color: palette?.textSecondary,
      fontSize: 11,
      fontWeight: '600',
      lineHeight: 14,
    },
    deliveryRunNextStops: {
      borderRadius: 14,
      borderWidth: 1,
      borderColor: palette?.borderSoft,
      backgroundColor: palette?.cardBgSoft,
    ...
    deliveryRunNextStopItem: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: 8,
    },
    deliveryRunNextStopText: {
      flex: 1,
      color: palette?.textPrimary,
      fontSize: 11,
      fontWeight: '700',
