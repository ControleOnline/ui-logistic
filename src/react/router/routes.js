...
const logisticRoutes = [
  ...
  },
  {
    ...
    options: {headerShown: true, showBottomCart: false, showBottomToolBar: true, showCompanyFilter: false, title: 'CT-e'},
    path: 'cte',
  },
  {
    name: 'CteEmitPage',
    component: CteEmitPage,
    options: {headerShown: true, showBottomCart: false, showBottomToolBar: true, showCompanyFilter: false, title: 'Emitir CT-e'},
    path: 'cte/emit',
  },
];
